...
#SBATCH --output /users/$USER/Legitron/reports/analysis/Anal-%x.%j.out
#SBATCH --error /users/$USER/Legitron/reports/analysis/Anal-%x.%j.err
#SBATCH --nodes 4           
...
SCRIPT_PATH="/users/$USER/Legitron/evaluation/Analysis.py"
